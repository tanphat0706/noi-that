                    ...
                    <div class="grid">
                        @foreach($cates as $cate)
                            ...
                            <div class="thumbnail-media">
                                <a href="{{route('detail-category',$cate->id)}}">
                            ...
                            <div class="thumbnail-body">
                                <div class="overlay">
                                    ...
                                    <a href="{{route('detail-category',$cate->id)}}" class="button">Xem chi tiết</a>
                                </div>
                            </div>
                        </article>
                        @endforeach
                        ...
                        @foreach($product_high as $item)
                            ...
                            <div class="thumbnail-media ">
                                <a href="#crafthouse/product/leather-stool/">
                                    <img width="480" height="480" src="{{asset('images/products/'.$item->image_1)}}" class="attachment-layers-square-medium size-layers-square-medium" alt="{{$item->name}}" title="{{$item->name}}" sizes="(max-width: 480px) 100vw, 480px"> </a>
                            </div>
                            <div class="thumbnail-body">
                                <div class="overlay">
                                    <header class="article-title">
