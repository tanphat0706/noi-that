                ...
                <div class="inline-left-nav">
                    <nav class="nav nav-horizontal">
                        <ul id="menu-main-menu-1" class="menu">
                                ...
                                <ul class="sub-menu">
                                    @foreach($site_menus as $menu)
                                        <li class="menu-item-has-children">
                                            <a href="{{route('detail-category',$menu->id)}}">{{$menu->name}}</a>
                                            <ul class="sub-menu">
                                                @foreach($cate_menus->productOfCate($menu->id) as $item)
                                                <li>
                                                    <a href="#crafthouse/product/leather-stool/">{{$item->name}}</a>
                                                </li>
                                                @endforeach
                                            </ul>
                                        </li>
                            ...
                            <li><a href="#crafthouse/about/">About</a></li>
                        </ul>
                    </nav>
                </div>
                <div class="inline-site-logo">
                    <div class="logo">
                        <a href="#crafthouse/" class="custom-logo-link" rel="home" itemprop="url"><img width="151" height="138" src="{{asset('images/site-logo.png')}}" class="custom-logo" alt="site-logo" itemprop="logo" sizes="(max-width: 151px) 100vw, 151px"></a>
                ...
                <div class="inline-right-nav">
                    <nav class="nav nav-horizontal">
                        <ul id="menu-right-menu" class="menu">
                            <li><a href="#crafthouse/team/">Team</a></li>
                            <li><a href="#crafthouse/journal/">Journal</a></li>
                            <li><a href="#crafthouse/contact/">Contact</a></li>
                        </ul>
                    </nav>
